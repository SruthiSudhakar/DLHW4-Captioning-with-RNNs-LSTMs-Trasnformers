...
class ClassificationTransformer(nn.Module):
    ...
    def multi_head_attention(self, inputs):
        ...
        #############################################################################
        h1 = torch.matmul(self.softmax(torch.matmul(self.q1(inputs),self.k1(inputs).transpose(-2,-1))/np.sqrt(self.dim_k)),self.v1(inputs))        
        h2 = torch.matmul(self.softmax(torch.matmul(self.q2(inputs),self.k2(inputs).transpose(-2,-1))/np.sqrt(self.dim_k)),self.v2(inputs))
